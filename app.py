...
from flask_cors import CORS  # <-- import obrigatório
import yt_dlp

app = Flask(__name__)
# Permite requisições do seu domínio Netlify (e do ngrok, se ainda for usar)
CORS(app, origins=[
    'https://energydownload.netlify.app',
    'https://energybackend.ngrok.app'  # opcional, se ainda usar ngrok
])
...
@app.route('/')
def index():
    return "Energy Downloader API - Use as rotas /start, /status/<id>, /download/<id>, /download_single/<id>, /cleanup/<id>"
